...
public class ArenaResereQuickLotteryServiceShinagawaTests {
    ...
    void 品川区体育館早押し予約() throws InterruptedException, IOException {
        ArenaResereQuickLotteryServiceShinagawa service
            = new ArenaResereQuickLotteryServiceShinagawa(false, "", null, "00004348", "Teamreserve0721", 品川区体育館.スクエア荏原, "全面", 品川区抽選枠.午前);
        service.execute();
    }
    ...
    void 品川区体育館日付指定早押し予約() throws InterruptedException, IOException {
        ...
        targetTime.plusSeconds(90);

        ArenaResereQuickLotteryServiceShinagawa service
            = new ArenaResereQuickLotteryServiceShinagawa(new OriginalDate("2025/10/3"), targetTime.getHour(), targetTime.getMinute(), false, "", null, "00004348", "Teamreserve0721", 品川区体育館.スクエア荏原, "全面", 品川区抽選枠.午後1);
        service.execute();
    }
}
